...
class WC_Tillit_Checkout
{
    ...
    private function prepare_tillit_object()
    {
        ...
        $properties = [
            'messages' => [
                'title_precheck' => __('Business invoice', 'woocommerce-gateway-tillit'),
                'subtitle_precheck' => __('Enter company name to pay on invoice', 'woocommerce-gateway-tillit'),
                'title_order_intent_ok' => $this->WC_Tillit->title,
                'subtitle_order_intent_ok' =>$this->WC_Tillit->get_option('subtitle'),
                'title_order_intent_reject' => __('Not available for this order', 'woocommerce-gateway-tillit'),
