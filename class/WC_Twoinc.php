...
if (!class_exists('WC_Twoinc')) {
    class WC_Twoinc extends WC_Payment_Gateway
    {
        ...
        public function get_merchant_default_days_on_invoice()
        {
            ...
            if (!$days_on_invoice_last_checked_on || ($days_on_invoice_last_checked_on + 3600) <= time()) {
                ...
                if ($merchant_id && $this->get_option('api_key')) {
                    ...
                    $this->_log_response('GET', "/v1/merchant/{$merchant_id}", $response);
        ...
        public function on_order_completed($order_id)
        {
            ...
            $this->_log_response('POST', "/v1/order/{$twoinc_order_id}/fulfillments", $response);
        ...
        public function on_order_cancelled($order_id)
        {
            ...
            $this->_log_response('POST', "/v1/order/{$twoinc_order_id}/cancel", $response);
        ...
        public function sync_order_state($order_id, $persist)
        {
            ...
            $this->_log_response('GET', "/v1/order/{$twoinc_order_id}", $response);
...
?>
        ...
        public function process_payment($order_id)
        {
            ...
            $this->_log_response('POST', '/v1/order', $response);
        ...
        public function process_refund($order_id, $amount = null, $reason = '')
        {
            ...
            $this->_log_response('POST', "/v1/order/{$twoinc_order_id}/refund", $response);
        ...
        private function process_confirmation()
        {
            ...
            $this->_log_response('POST', "/v1/order/{$twoinc_order_id}/confirm", $response);
...
<?php
        ...
        private function update_twoinc_order($order)
        {
            ...
            $this->_log_response('PUT', "/v1/order/{$twoinc_order_id}", $response);
        ...
        {
            global $pagenow;
            if ($this->get_option('api_key') && $this->get_option('merchant_id')) {
                return;
            }
