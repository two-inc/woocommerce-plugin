...
if (!class_exists('WC_ABN_Checkout')) {
    class WC_ABN_Checkout
    {
        ...
        public function update_company_fields($fields)
        {
            ...
            if ($this->wc_abn->get_enable_company_search() === 'yes') {
        ...
        private function prepare_abn_object($merchant): array
        {
            ...
            $properties = [
                ...
                'enable_company_search' => $this->wc_abn->get_enable_company_search(),
                'enable_company_search_for_others' => $this->wc_abn->get_option('enable_company_search_for_others'),
                'enable_address_lookup' => $this->wc_abn->get_option('enable_address_lookup'),
        ...
        public function inject_cart_details()
        {
            ...
            $result = $this->wc_abn->verify_api_key();
