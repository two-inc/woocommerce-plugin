(function (window) {
    ...
    var decode = (wp.htmlEntities && wp.htmlEntities.decodeEntities) || function (value) {
        return value;
    };
    ...
    function Label() {
        return element.createElement(
            ...
            data.iconUrl
                ? element.createElement('img', { src: data.iconUrl, alt: title, className: 'twoinc-blocks-icon' })
                : null,
