...
function companyRowsMarkup(options) {
  ...
  return [
    ...
    "    </span>",
    "  </p>",
    '  <p id="company_name_field" class="form-row hidden" data-priority="31">',
    '    <label for="company_name">Company name&nbsp;<span class="optional">(optional)</span></label>',
    '    <span class="woocommerce-input-wrapper">',
    "      <input type='text' id='company_name' name='company_name' value='' />",
    "    </span>",
    "  </p>",
    '  <p id="company_id_field" class="form-row hidden" data-priority="32">',
