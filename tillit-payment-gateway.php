...
function load_abn_classes()
{
    ...
    add_action('wp_ajax_abn_verify_api_key', 'abn_ajax_verify_api_key');
 ...
 */
function abn_ajax_verify_api_key()
{
    ...
    // Verify nonce
    if (!wp_verify_nonce($_POST['nonce'], 'abn_admin_nonce')) {
    ...
    $abn_instance = WC_ABN::get_instance();
    $result = $abn_instance->verify_api_key($api_key);
    ...
    if ($result && isset($result['code']) && $result['code'] == 200) {
        ...
        $debug_info = [
            ...
            'host' => $abn_instance->get_abn_checkout_host()
        ];
