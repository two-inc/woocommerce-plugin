...
?>
    <div class="wrap">
        <h1><?php sprintf(_e('%s API Logs', 'twoinc-payment-gateway'), WC_Twoinc::PRODUCT_NAME); ?></h1>
        ...
        <div id="log-viewer" style="background: #fff; border: 1px solid #ccd0d4; padding: 10px; margin-bottom: 10px;">
            <pre style="white-space: pre-wrap; word-wrap: break-word; max-height: 500px; overflow-y: scroll;"><?php
                                                                                                                if ($log_content) {
